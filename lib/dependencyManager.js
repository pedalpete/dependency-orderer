...
var build_list = {
    ...
    getDeps: function(dependency){
        if(dependency.missing) return console.log('missing dependency for dependency orderer', dependency); //a missing dependency from bower, ignore it's dependencies
